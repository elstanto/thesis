...
\begin{figure}
	...
	\caption{The propagation of measurement uncertainty through the measurement model, as specified in the GUM. Here, a single measurand $Y$ is shown, but the model could include multiple measurands.}
	\label{ch3_fig_model}
\end{figure}
